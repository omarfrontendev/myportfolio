      ...
      <div className="container contact_container">
        <div className="contact_options">
          <article data-aos="fade-up" className="contact_options-card">
            <HiOutlineMail/>
            <h4>Email</h4>
            <small>omar.abdelrhman.dev@gmail.com</small>
            <a target='_blank' href='mailto:omar.abdelrhman.dev@gmail.com'>Send Message</a>
          </article>
          <article data-aos="fade-up" data-aos-delay='100' className="contact_options-card">
            <RiMessengerLine/>
            <h4>messenger</h4>
            <small>In Facebook</small>
            <a target='_blank' href='https://m.me/profile.php?id=100076393777810'>Send Message</a>
          </article>
          <article data-aos="fade-up" data-aos-delay='200' className="contact_options-card">
            <BsWhatsapp/>
            <h4>WhatsApp</h4>
            <small>+01210196313</small>
            <a target='_blank' href='https://api.whatsapp.com/send?phone=02001210196313'>Send Message</a>
          </article>
        </div>
